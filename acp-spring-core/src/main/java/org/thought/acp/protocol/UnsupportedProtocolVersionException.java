 ...
 *
 * <p>Thrown during the handshake rather than during a turn, which is the point: the alternative is
 * a conversation that decodes into the wrong shapes and fails somewhere further on, where nothing
 * names the cause.
 */
