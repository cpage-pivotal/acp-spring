...
import org.thought.acp.transport.WebSocketAgentTransport;
import org.thought.acp.workspace.WorkspaceFileSystem;
import org.thought.acp.workspace.WorkspaceTerminals;
...
public final class AgentClientFactory {
	...
	private static final String CLIENT_NAME = "acp-spring";
