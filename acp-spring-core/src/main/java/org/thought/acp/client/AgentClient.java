...
public interface AgentClient extends AutoCloseable {
	...
	default int protocolVersion() {
		return org.thought.acp.protocol.AcpProtocol.V1;
	}
	 ...
	 */
	org.thought.acp.session.AgentSessions sessions();
	 ...
	 */
	java.util.Optional<org.thought.acp.session.AgentSession> session(String name);
