...
/**
 * The listing that replaces the agent's own catalogue for an endpoint the application named.
 *
 * <p>Against a real HTTP server rather than a mocked client: what is being tested is a wire format
 * and the handling of an endpoint that declines to speak it, neither of which a mock would notice
 * getting wrong.
 */
