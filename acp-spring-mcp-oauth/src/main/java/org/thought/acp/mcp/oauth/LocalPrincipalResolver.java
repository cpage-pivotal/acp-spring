 ...
 *
 * <p>There is exactly one, and every session is theirs, so their tokens are kept under their name
 * and a second user on the same machine — with their own config directory — keeps their own.
 */
